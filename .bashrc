...
if [[ $- == *i* ]]; then
    ...
    if [[ -f ~/.bash_functions ]]; then
        ...
        export PATH=$HOME/.local/bin:/opt/csw/gnu:/opt/csw/sbin:/opt/csw/bin:/usr/local/sbin:/usr/local/bin:/sbin:/bin:/usr/sbin:/usr/bin:/root/bin
        export EDITOR=vi
        ...
        alias vi='TERM=xterm /opt/csw/bin/vim -X' 2>/dev/null
        alias l='LC_ALL=C /opt/csw/gnu/ls --color=auto --group-directories-first -lah' 2>/dev/null
